...
def create_parameter_map_by_type(tissue_state: TissueState) -> dict[CloneType, dict]:
    """
    ...
    unique_cell_types = {clone.cell_type for clone in tissue_state.clones.values()}
